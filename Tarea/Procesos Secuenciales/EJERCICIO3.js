// 3. Solicitar al usuario dos numeros y mostar su suma.
...
// FinAlgoritmo
 ...
 function _ejercicio_3(){
    numero1 = read("Hola, ingrese el primer numero:")
    numero2 = read("Ahora ingrese el segundo numero:")
    suma = numero1 + numero2
    write("La suma de los dos numeros es:", suma)
 }
_ejercicio_3();
